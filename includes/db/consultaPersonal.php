...
if (!$ejecutaConsulta){
    ...
    if ($VerFilas<1) {
        ...
        echo "<table> <tr> <th>Código de empleado</th> <th>Nombre</th> <th>Direccion</th> <th>Telefono</th> <th>Correo</th> </tr>";
        //echo "#Filas= $VerFilas";
        for($i=0; $i<=$filas; $i++){
            echo "<tr> <td>$filas[0]</td> <td>$filas[1]</td> <td>$filas[2]</td> <td>$filas[3]</td>  <td>$filas[4]</td></tr>";
