            ...
            <form action="registrarVenta.php" method="POST">
                <div class="fila">
                    ...
                    <div class="fila">
                     ...
                     <!--Metodos de pago-->
                    <h2 style="margin:15px 15px;">Elige un metodo de pago</h2>
                    <div class="fila">
                    ...
                    <div class="fila">
                        <div class="col">
                            <input type="submit" name="add" value="Añadir" style="width: 110px;height: 30px;margin-bottom: 10px;background-color:#42b881;color:#fff;">
                        </div>
                        <div class="col">
                            <input type="submit" name="enviar" value="Finalizar" style="width: 110px;height: 30px;margin-bottom: 10px;background-color:#42b881;color:#fff;">
                        </div>
                        <!--
                        <div class="col">
